                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-16">
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                ...
                                <li><a href="/about" className="hover:text-white transition">FAQ</a></li>
                            </ul>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-3">
                                ...
                                <li><a href="/size-chart" className="hover:text-white transition">Size Guide</a></li>
                                <li><a href="/about" className="hover:text-white transition">Shipping Info</a></li>
                            </ul>
                        </div>
